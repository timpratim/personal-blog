...
import { APIUserAbortError } from 'test-trebllewith-stainless';
import { Headers } from 'test-trebllewith-stainless/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    test('trailing slash', () => {
      const client = new TestTrebllewithStainless({ baseURL: 'http://localhost:5000/custom/path/' });
    ...
    afterEach(() => {
      process.env['TEST_TREBLLEWITH_STAINLESS_BASE_URL'] = undefined;
    });

    test('explicit option', () => {
      const client = new TestTrebllewithStainless({ baseURL: 'https://example.com' });
      expect(client.baseURL).toEqual('https://example.com');
    });

    test('env variable', () => {
      process.env['TEST_TREBLLEWITH_STAINLESS_BASE_URL'] = 'https://example.com/from_env';
      const client = new TestTrebllewithStainless({});
      expect(client.baseURL).toEqual('https://example.com/from_env');
    });

    test('empty env variable', () => {
      process.env['TEST_TREBLLEWITH_STAINLESS_BASE_URL'] = ''; // empty
      const client = new TestTrebllewithStainless({});
      expect(client.baseURL).toEqual('https://localhost');
    });

    test('blank env variable', () => {
      process.env['TEST_TREBLLEWITH_STAINLESS_BASE_URL'] = '  '; // blank
      const client = new TestTrebllewithStainless({});
      expect(client.baseURL).toEqual('https://localhost');
    });
  });
  ...
  test('maxRetries option is correctly set', () => {
    const client = new TestTrebllewithStainless({ maxRetries: 4 });
    expect(client.maxRetries).toEqual(4);

    // default
    const client2 = new TestTrebllewithStainless({});
...
describe('retries', () => {
  test('retry on timeout', async () => {
    ...
    const client = new TestTrebllewithStainless({ timeout: 10, fetch: testFetch });
  ...
  test('retry count header', async () => {
    ...
    const client = new TestTrebllewithStainless({ fetch: testFetch, maxRetries: 4 });
  ...
  test('retry on 429 with retry-after', async () => {
    ...
    const client = new TestTrebllewithStainless({ fetch: testFetch });
